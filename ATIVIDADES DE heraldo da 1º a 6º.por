programa
{
	...
	funcao inicio()
	{
		...
		se ((idade >= 0) e (idade<= 12)){
			escreva("é uma criança ainda!")
		}senao se ((idade >= 13) e (idade <= 17)){
			escreva ("é adolescente ")
		}senao se ((idade >= 18) e (idade <= 64)){
			escreva("é um adulto já")
		}senao se ((idade >= 65) e (idade <= 5000)){
			escreva("é velho ")
		*/
